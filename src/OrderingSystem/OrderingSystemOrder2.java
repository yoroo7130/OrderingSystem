...
public class OrderingSystemOrder2 {
	...
	public OrderingSystemOrder2(ArrayList foodName2, ArrayList foodCount2, ArrayList foodPrice2, int menuCount, int tableNum) {
		...
		OrderingSystemOrder2 order = new OrderingSystemOrder2();
		for (int i = 0; i < 8; i++) {
			if (tableNum == i) {
				n = i;
			}
