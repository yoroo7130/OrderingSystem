...
public class OrderingSystemOrder1 {
	...
	public OrderingSystemOrder1(ArrayList foodName2, ArrayList foodCount2, ArrayList foodPrice2, int menuCount, int tableNum) {
		...
		OrderingSystemOrder1 order = new OrderingSystemOrder1();
		for (int i = 0; i < 8; i++) {
			if (tableNum == i) {
				n = i;
			}
