...
public class OrderingSystemOrder8 {
	...
	public OrderingSystemOrder8(ArrayList foodName2, ArrayList foodCount2, ArrayList foodPrice2, int menuCount, int tableNum) {
		...
		OrderingSystemOrder8 order = new OrderingSystemOrder8();
		for (int i = 0; i < 8; i++) {
			if (tableNum == i) {
				n = i;
			}
