...
public class OrderingSystemOrder5 {
	...
	public OrderingSystemOrder5(ArrayList foodName2, ArrayList foodCount2, ArrayList foodPrice2, int menuCount, int tableNum) {
		...
		OrderingSystemOrder5 order = new OrderingSystemOrder5();
		for (int i = 0; i < 8; i++) {
			if (tableNum == i) {
				n = i;
			}
