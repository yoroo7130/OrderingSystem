...
public class OrderingSystemOrder7 {
	...
	public OrderingSystemOrder7(ArrayList foodName2, ArrayList foodCount2, ArrayList foodPrice2, int menuCount, int tableNum) {
		...
		OrderingSystemOrder7 order = new OrderingSystemOrder7();
		for (int i = 0; i < 8; i++) {
			if (tableNum == i) {
				n = i;
			}
