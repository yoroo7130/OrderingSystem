...
public class OrderingSystemOrder3 {
	...
	public OrderingSystemOrder3(ArrayList foodName2, ArrayList foodCount2, ArrayList foodPrice2, int menuCount, int tableNum) {
		...
		OrderingSystemOrder3 order = new OrderingSystemOrder3();
		for (int i = 0; i < 8; i++) {
			if (tableNum == i) {
				n = i;
			}
