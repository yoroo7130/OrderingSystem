...
public class OrderingSystemOrder4 {
	...
	public OrderingSystemOrder4(ArrayList foodName2, ArrayList foodCount2, ArrayList foodPrice2, int menuCount, int tableNum) {
		...
		OrderingSystemOrder4 order = new OrderingSystemOrder4();
		for (int i = 0; i < 8; i++) {
			if (tableNum == i) {
				n = i;
			}
